...
function OrderDetails() {
  ...
  const buttons10 = [
    {
      disabled: !isTherePrinters || processLoading || !printerConnected,
      icon: <BsPrinterFill />,
    ...
    {
      disabled: processLoading || fetchLoading,
      icon: <BiDownload />,
      text: "Скачать чек",
      onClick: () => {
        const { discount } = data;
  ...
  return (
    <div className="pageWrapper">
      ...
      >
        ...
        <BiPrinter
          title={printerConnected ? "Принтер работает" : "Принтер не подключен"}
          size={30}
